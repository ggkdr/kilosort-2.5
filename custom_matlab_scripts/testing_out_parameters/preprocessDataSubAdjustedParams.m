...
NTbuff      = NT + 3*ops.ntbuff; % we need buffers on both sideshold on projections (like in Kilosort1, can be different for last pass like [10 4])
ops.Th = [9 3.5]; %230516 -- decided on this adjustment @KGG @LT
% default [10 4]
% Th(1) used during optimization
% Th(2) used during final pass
% 
...
% shold on projections (like in Kilosort1, can be different for last pass like [10 4])
ops.Th = [9 3.5]; %230516 -- decided on this adjustment @KGG @LT
% default [10 4]
% Th(1) used during optimization
% Th(2) used during final pass
